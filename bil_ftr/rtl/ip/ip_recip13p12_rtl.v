...
module ip_recip13p12

#(
  parameter                         IPRCIS    = 13,             // input  precision
  parameter                         OPRCIS    = 12,             // output precision
...
assign  a0_prod_adj = {14{denm_lead_one[ 1]}} & {a0_prod[ 9: 0], 4'h0} |
                      ...
                      {14{denm_lead_one[12]}} & {a0_prod[20: 7]};
...
/*
assign  x1_prod_adj = {OPRCIS{denm_lead_one_q[ 1]}} & {       x1_prod[21 -: 12]}  |
                      {OPRCIS{denm_lead_one_q[ 2]}} & { 1'h0, x1_prod[21 -: 11]}  |
                      {OPRCIS{denm_lead_one_q[ 3]}} & { 2'h0, x1_prod[21 -: 10]}  |
                      {OPRCIS{denm_lead_one_q[ 4]}} & { 3'h0, x1_prod[21 -:  9]}  |
                      {OPRCIS{denm_lead_one_q[ 5]}} & { 4'h0, x1_prod[21 -:  8]}  |
                      {OPRCIS{denm_lead_one_q[ 6]}} & { 5'h0, x1_prod[21 -:  7]}  |
                      {OPRCIS{denm_lead_one_q[ 7]}} & { 6'h0, x1_prod[21 -:  6]}  |
                      {OPRCIS{denm_lead_one_q[ 8]}} & { 7'h0, x1_prod[21 -:  5]}  |
                      {OPRCIS{denm_lead_one_q[ 9]}} & { 8'h0, x1_prod[21 -:  4]}  |
                      {OPRCIS{denm_lead_one_q[10]}} & { 9'h0, x1_prod[21 -:  3]}  |
                      {OPRCIS{denm_lead_one_q[11]}} & {10'h0, x1_prod[21 -:  2]}  |
                      {OPRCIS{denm_lead_one_q[12]}} & {11'h0, x1_prod[21 -:  1]};


assign  x1_rnd_bit  = {X1SZ-1{denm_lead_one_q[ 1]}} & {11'h0, 1'b1,  9'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 2]}} & {10'h0, 1'b1, 10'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 3]}} & { 9'h0, 1'b1, 11'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 4]}} & { 8'h0, 1'b1, 12'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 5]}} & { 7'h0, 1'b1, 13'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 6]}} & { 6'h0, 1'b1, 14'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 7]}} & { 5'h0, 1'b1, 15'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 8]}} & { 4'h0, 1'b1, 16'h0}  |
                      {X1SZ-1{denm_lead_one_q[ 9]}} & { 3'h0, 1'b1, 17'h0}  |
                      {X1SZ-1{denm_lead_one_q[10]}} & { 2'h0, 1'b1, 18'h0}  |
                      {X1SZ-1{denm_lead_one_q[11]}} & { 1'h0, 1'b1, 19'h0}  |
                      {X1SZ-1{denm_lead_one_q[12]}} & {       1'b1, 20'h0};
