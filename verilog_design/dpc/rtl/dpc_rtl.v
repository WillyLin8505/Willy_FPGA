...
module dpc_modify
   ...
   #( 
      ...
      //---------------------------------------------config
      parameter  MODE_SEL           = 3, //1 : static mode , 2 : dynamic mode , 3 : static + dynamic mode 
...
//-----------------------------------------------------------------------------------------------------------delay 
localparam    STEP_1_RESULT_SEL_DLY        = COLOR_ARRAY_NUM_2 ;
...
localparam    STEP_1_NLM_RTO_DLY           = 2; // nlm_rto_0_sgn_nxt , nlm_rto_1_sgn_nxt
localparam    STEP_1_SCORE_DLY             = 1; // df_step_1_score_nxt
localparam    RECIP_DLY                    = 3; // ip_sqrt_pw
localparam    NLM_CLIP_DLY                 = 1; // nlm_clip_nxt
localparam    TOTAL_NLM_DLY                = 2; // total_nlm_0_nxt total_nlm_1_nxt
localparam    TOTAL_NLM_CLIP_DLY           = 1; // total_nlm_clip_nxt
localparam    STEP_2_MAX_MIN_SEL_NUM_DLY   = 1; // step_2_max_sel_num_nxt
localparam    STEP_2_MAX_MIN_0_DLY         = 1; // step_2_color_1_max_0_sgn_nxt , step_2_color_1_min_0_sgn_nxt
localparam    STEP_2_MAX_MIN_1_DLY         = 1; // step_2_color_1_max_1_sgn_nxt , step_2_color_1_min_1_sgn_nxt
...
localparam    STEP_2_TOTAL_SUM_DLY         = 3; // step_2_color_total_sum_nxt
localparam    STEP_2_SCORE_INV             = 1; // df_step_2_score_inv_nxt
localparam    STEP_2_ALL_SCR_DLY           = 1; // df_all_step_score_nxt
localparam    STEP_2_RPEL_PX_DLY           = 2; // repl_pixel_0_nxt repl_pixel_1_nxt
localparam    STEP_2_EN_DLY                = 1; // step_2_en_nxt
localparam    OUTPUT_DLY                   = 1; // o_data_nxt
localparam    STATIC_DLY                   = 1;

localparam    COM_CLR_4_DLY                    = (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY + 
                                                  STEP_1_BIT_RESULT_DLY)                                - 1;
localparam    COM_STEP_1_RAW_FNL_DLY           = (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY + 
                                                  STEP_1_BIT_RESULT_DLY + STEP_1_RAW_MAX_MIN_DLY)       - 1;
localparam    COM_NLM_IP_DLY                   = (TOTAL_NLM_DLY + NLM_CLIP_DLY +
                                                  TOTAL_NLM_CLIP_DLY + RECIP_DLY);
localparam    COM_STEP_1_RAW_MAX_MIN_DLY       = (COM_NLM_IP_DLY+STEP_1_RESULT_SEL_DLY+
                                                  STEP_1_ALL_SAME_DLY+STEP_1_BIT_RESULT_DLY+
                                                  STEP_1_RAW_MAX_MIN_DLY+STEP_1_RAW_FNL_SEL_DLY)        - (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY+
                                                                                                           STEP_1_BIT_RESULT_DLY+STEP_1_RAW_MAX_MIN_DLY+1);   
localparam    COM_STEP_1_NLM_RTO_DLY           = (COM_STEP_1_RAW_MAX_MIN_DLY + STEP_1_NLM_RTO_DLY);                                   

localparam    COM_STEP_1_1_TOTAL_DLY           = (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY+
                                                  STEP_1_BIT_RESULT_DLY+STEP_1_RAW_MAX_MIN_DLY);
localparam    COM_STEP_1_2_TOTAL_DLY           = (COM_STEP_1_1_TOTAL_DLY +
                                                  STEP_1_NLM_RTO_DLY+STEP_1_SCORE_DLY);
localparam    COM_STEP_2_CLR_MAX_MIN_SQRT_DLY  = (COM_STEP_1_1_TOTAL_DLY+STEP_2_MAX_MIN_SEL_NUM_DLY)    - (COM_NLM_IP_DLY+1);
localparam    COM_STEP_2_CLR_MAX_MIN_CLR_DLY   = (COM_STEP_1_1_TOTAL_DLY+STEP_2_MAX_MIN_SEL_NUM_DLY+
                                                  STEP_2_MAX_MIN_0_DLY);
localparam    COM_STEP_2_COL_CLIP_DLY          = (COM_STEP_1_1_TOTAL_DLY+STEP_2_MAX_MIN_SEL_NUM_DLY + 
                                                  STEP_2_MAX_MIN_0_DLY+ STEP_2_MAX_MIN_1_DLY);                          
localparam    COM_STEP_2_COL_SUM_DLY           = (COM_STEP_2_COL_CLIP_DLY + STEP_2_COL_CLIP + 
                                                  STEP_2_COL_SUM_DLY);                                                            
localparam    COM_STEP_2_COL_SEL_NUM_DLY       = (COM_STEP_2_COL_SUM_DLY)                               - (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY+
                                                                                                           STEP_1_BIT_RESULT_DLY+STEP_1_PTNL_DLY+1);
...
localparam    COM_STEP_2_ALL_SCR_DLY           = (COM_STEP_2_COL_SUM_DLY)                               - (COM_STEP_1_2_TOTAL_DLY+1);
localparam    COM_STEP_2_REPL_DLY              = (COM_STEP_2_COL_SUM_DLY + STEP_2_STG_0_DLY+
                                                  ...
                                                  STEP_2_ALL_SCR_DLY)                                   - (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY+STEP_1_BIT_RESULT_DLY+1);
localparam    COM_STEP_2_REPL_RAW_FNL_DLY      = (COM_STEP_2_COL_SUM_DLY + STEP_2_STG_0_DLY+
                                                  ...
                                                  STEP_2_SCORE_INV)                                     - (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY+
                                                                                                           STEP_1_BIT_RESULT_DLY+STEP_1_RAW_MAX_MIN_DLY+1);
...
localparam    COM_STA_FNL_STA_SEL_DLY          = (COM_STEP_2_COL_SUM_DLY + STEP_2_SEL_NUM_DLY+
                                                  ...
                                                  STEP_2_TOTAL_SUM_DLY + STEP_2_SCORE_INV+
                                                  STEP_2_ALL_SCR_DLY + STEP_2_RPEL_PX_DLY)              - (STEP_1_RESULT_SEL_DLY+STEP_1_ALL_SAME_DLY+
                                                                                                           STEP_1_BIT_RESULT_DLY+STEP_1_RAW_MAX_MIN_DLY+1);
localparam    COM_STA_ALL_SCORE_DLY            = (STEP_1_PTNL_DLY+COM_STEP_1_1_TOTAL_DLY+
                                                  STEP_2_MAX_MIN_SEL_NUM_DLY+
                                                  STEP_2_MAX_MIN_0_DLY+STEP_2_MAX_MIN_1_DLY+
                                                  STEP_2_COL_SUM_DLY+STEP_2_COL_CLIP+
                                                  STEP_2_STG_0_DLY+STEP_2_STG_1_DLY+
                                                  STEP_2_SEL_NUM_DLY+STEP_2_TOTAL_SUM_DLY+
                                                  STEP_2_SCORE_INV)                                    - (STATIC_DLY+1);                       
...
reg         [RAW_CIW*(COLOR_ARRAY_NUM_2-1)-1:0]                        data_bit;
wire        [RAW_CIW*(COLOR_ARRAY_NUM_2-1)-1:0]                        data_bit_nxt;
reg         [RAW_CIW*(COLOR_ARRAY_NUM_2-1)-1:0]                        data_bit_pipe                   [0:RAW_CIW-1];
wire        [RAW_CIW*(COLOR_ARRAY_NUM_2-1)-1:0]                        data_bit_pipe_nxt               [0:RAW_CIW-1];
reg                                                                    all_same;
wire                                                                   all_same_nxt;
reg         [(COLOR_ARRAY_NUM_2-1)-1:0]                                bit_result_max                  [0:RAW_CIW-1];
wire        [(COLOR_ARRAY_NUM_2-1)-1:0]                                bit_result_max_nxt              [0:RAW_CIW-1];
reg         [(COLOR_ARRAY_NUM_2-1)-1:0]                                bit_result_min                  [0:RAW_CIW-1];
wire        [(COLOR_ARRAY_NUM_2-1)-1:0]                                bit_result_min_nxt              [0:RAW_CIW-1];
reg         [COLOR_ARRAY_NUM_2-1-1:0]                                  result_max_sel                  [0:RAW_CIW-2];
wire        [COLOR_ARRAY_NUM_2-1-1:0]                                  result_max_sel_nxt              [0:RAW_CIW-2];
reg         [COLOR_ARRAY_NUM_2-1-1:0]                                  result_min_sel                  [0:RAW_CIW-2];
wire        [COLOR_ARRAY_NUM_2-1-1:0]                                  result_min_sel_nxt              [0:RAW_CIW-2];
...
wire signed [BLC_CIW+1-1:0]                                            nlm_sgn                         [0:COLOR_ARRAY_NUM_2-1]; //add 1 for signed 
reg         [BLC_CIW-1:0]                                              nlm_clip                        [0:COLOR_ARRAY_NUM_2-1]; 
wire        [BLC_CIW-1:0]                                              nlm_clip_nxt                    [0:COLOR_ARRAY_NUM_2-1]; 
reg         [SHOT_CIW+(BLC_CIW-1)+BLC_TGT_CIPW-1:0]                    total_nlm_0                     [0:COLOR_ARRAY_NUM_2-1]; 
wire        [SHOT_CIW+(BLC_CIW-1)+BLC_TGT_CIPW-1:0]                    total_nlm_0_nxt                 [0:COLOR_ARRAY_NUM_2-1]; 
reg         [SQRT_CIW-1:0]                                             total_nlm_1                     [0:COLOR_ARRAY_NUM_2-1]; 
wire        [SQRT_CIW-1:0]                                             total_nlm_1_nxt                 [0:COLOR_ARRAY_NUM_2-1]; 
...
reg  signed [RAW_CIW+SQRT_RECIP_COW+1-1:0]                             nlm_rto_0_sgn;             // add 1 for signed bit 
wire signed [RAW_CIW+SQRT_RECIP_COW+1-1:0]                             nlm_rto_0_sgn_nxt;         //the result always positive, use the signed bit to prevent error result 
reg  signed [RAW_CIW+SQRT_RECIP_COW+1-1:0]                             nlm_rto_1_sgn;             // add 1 for signed bit 
wire signed [RAW_CIW+SQRT_RECIP_COW+1-1:0]                             nlm_rto_1_sgn_nxt;         //the result always positive, use the signed bit to prevent error result 
...
reg         [R_RTO_THRES_CIW:0]                                         step_2_max_sel_num;  
wire        [R_RTO_THRES_CIW:0]                                         step_2_max_sel_num_nxt;  
reg         [R_RTO_THRES_CIW:0]                                         step_2_min_sel_num;    
wire        [R_RTO_THRES_CIW:0]                                         step_2_min_sel_num_nxt;    
...
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_max_0_sgn             [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_max_0_sgn_nxt         [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_min_0_sgn             [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_min_0_sgn_nxt         [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_max_1_sgn             [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_max_1_sgn_nxt         [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_min_1_sgn             [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_1_min_1_sgn_nxt         [0:STAGE_2_NBR_4-1]; //add 1 for signed , add 1 for over boundary 
...
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_max_0_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_max_0_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_min_0_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_min_0_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_max_1_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_max_1_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_min_1_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_2_min_1_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
...
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_max_0_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_max_0_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_min_0_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_min_0_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_max_1_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_max_1_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
reg  signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_min_1_sgn             [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
wire signed [RAW_CIW+SQRT_COPW+R_RTO_THRES_CIPW+2-1:0]                  step_2_color_3_min_1_sgn_nxt         [0:STAGE_2_NBR_2-1]; //add 1 for signed , add 1 for over boundary 
...
reg         [RAW_CIW+SCORE_STG_1_N5_CIW+0-1:0]                          step_2_color_total_sum_0;   
wire        [RAW_CIW+SCORE_STG_1_N5_CIW+0-1:0]                          step_2_color_total_sum_0_nxt;  //3.10
reg         [RAW_CIW+SCORE_STG_1_N5_CIW+0-1:0]                          step_2_color_total_sum_1;
wire        [RAW_CIW+SCORE_STG_1_N5_CIW+0-1:0]                          step_2_color_total_sum_1_nxt;  //3.10
reg         [RAW_CIW+SCORE_STG_1_N5_CIW+1-1:0]                          step_2_color_total_sum_2;
wire        [RAW_CIW+SCORE_STG_1_N5_CIW+1-1:0]                          step_2_color_total_sum_2_nxt;  //4.10
reg         [RAW_CIW+SCORE_STG_1_N5_CIW+1-1:0]                          step_2_color_total_sum_3;
wire        [RAW_CIW+SCORE_STG_1_N5_CIW+1-1:0]                          step_2_color_total_sum_3_nxt;  //4.10
reg         [RAW_CIW+SCORE_STG_1_N5_CIW+1-1:0]                          step_2_color_total_sum_4;
wire        [RAW_CIW+SCORE_STG_1_N5_CIW+1-1:0]                          step_2_color_total_sum_4_nxt;  //4.10
reg         [RAW_CIW+SCORE_STG_1_N5_CIW+2-1:0]                          step_2_color_total_sum_5;
wire        [RAW_CIW+SCORE_STG_1_N5_CIW+2-1:0]                          step_2_color_total_sum_5_nxt;  //5.10
reg         [RAW_CIW+SCORE_STG_1_N5_CIW+3-1:0]                          step_2_color_total_sum;
wire        [RAW_CIW+SCORE_STG_1_N5_CIW+3-1:0]                          step_2_color_total_sum_nxt;    //6.10                     //add 3 for sum 8 value
...
reg         [RAW_CIW+1+RAW_CIW+R_LOW_NLM_CIPW:0]                        repl_pixel_0;               //11.12
wire        [RAW_CIW+1+RAW_CIW+R_LOW_NLM_CIPW:0]                        repl_pixel_0_nxt;           //11.12
reg         [RAW_CIW+1+RAW_CIW+R_LOW_NLM_CIPW:0]                        repl_pixel_1;               //11.12
wire        [RAW_CIW+1+RAW_CIW+R_LOW_NLM_CIPW:0]                        repl_pixel_1_nxt;           //11.12
reg         [RAW_CIW+1+RAW_CIW+R_LOW_NLM_CIPW:0]                        repl_pixel_total;           //11.12
wire        [RAW_CIW+1+RAW_CIW+R_LOW_NLM_CIPW:0]                        repl_pixel_total_nxt;       //11.12
...
//-----------------------------------------------------------------------------------------------------------sqrt_pw
reg         [(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)-1:0]                                      nlm_sqrt;
wire        [(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)-1:0]                                      nlm_sqrt_nxt; 
reg         [(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*(COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+2)-1:0]  nlm_sqrt_que;
wire        [(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*(COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+2)-1:0]  nlm_sqrt_que_nxt;
...
//--------------------------------------------------------------------------------------find max and min number
 ...
 generate 
  for (index=0;index<RAW_CIW;index=index+1) begin : data_bit_gen //num:8  //data_bit[0] is i_data MSB  
    assign data_bit_nxt[(COLOR_ARRAY_NUM_2-1)*(RAW_CIW-index-1)+:(COLOR_ARRAY_NUM_2-1)] = {step_1_color_4_nxt[RAW_CIW*(COLOR_ARRAY_NUM_2-0)-index-1], //0
...
assign data_bit_pipe_nxt[0] = data_bit_nxt;
...
assign total_nlm_0_nxt[index]     = nlm_clip[index] * i_shot_nvar_bs_cu;                                            // precision : (11.0 * 4.12)= 15.12   
assign total_nlm_1_nxt[index]     = total_nlm_0[index][SQRT_CIPW-SQRT_CIPW+:SQRT_CIIW+SQRT_CIPW] + i_rout_nvar_bs_cu[ROUT_CIPW-SQRT_CIPW+:ROUT_CIW+SQRT_CIPW] + 
                                    {1'b1,{CGCF_CIPW-SQRT_CIPW-1{1'b0}}};                                           // precision : 15.12 + 8.12 = 16.12 + rounding 
                                                                                                                    //fix rounding 14.4 + 8.4  
assign total_nlm_clip_nxt[index]  = (total_nlm_1[index][CGCF_CIPW-SQRT_CIPW+:SQRT_CIW] >= {{1'b1},{(SQRT_CIPW-1){1'b0}},{1'b1}}) ? total_nlm_1[index][CGCF_CIPW-SQRT_CIPW+:SQRT_CIW] : 
                                    {{1'b1},{(SQRT_CIPW-1){1'b0}},{1'b1}};                                          // precision : 14.4
end

assign nlm_sqrt_nxt[0+:((SQRT_CIW/2)+IP_SQRT_OEXD)] = 0;

assign nlm_sqrt_que_nxt           = {nlm_sqrt_que         [0+:(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2) * (COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+1)],nlm_sqrt};
...
assign df_rto_1_sel_num_nxt          = ptnl_w_point_nxt                                 ? raw_max_fnl                      : target_pixel_que_nxt[0+:RAW_CIW];
...
assign nlm_rto_0_sgn_nxt             = $signed({1'b0,df_rto_0_sel_num_que_nxt[RAW_CIW*COM_STEP_1_RAW_MAX_MIN_DLY+:RAW_CIW]} -   
                                               {1'b0,df_rto_1_sel_num_que_nxt[RAW_CIW*COM_STEP_1_RAW_MAX_MIN_DLY+:RAW_CIW]});   
                                                                                                                                                //precision : (10.0-10.0) = 10.0
assign nlm_rto_1_sgn_nxt             = nlm_rto_0_sgn * $signed({1'b0,max_min_recip_sel_num});   
                                                                                                                                                //precision : 10.0*0.10 = 10.10  
                                                                                                                                                //can't reduce
                                                                                                                                                                                              
  if (SQRT_RECIP_COPW == RAW_CIW) //not rounding 
  assign df_clip_nlm =  
       (nlm_rto_1_sgn[SQRT_RECIP_COPW-R_LOW_NLM_CIPW+:(R_LOW_NLM_CIW+1)] >= step_1_high_nlm_sel_num_que_nxt[(R_LOW_NLM_CIW+1)*(COM_STEP_1_NLM_RTO_DLY)+:(R_LOW_NLM_CIW+1)]) ? 
       ...
       (nlm_rto_1_sgn[SQRT_RECIP_COPW-R_LOW_NLM_CIPW+:(R_LOW_NLM_CIW+1)] < step_1_low_nlm_sel_num_que_nxt[R_LOW_NLM_CIW*(COM_STEP_1_NLM_RTO_DLY)+:R_LOW_NLM_CIW]) ? 
       ...
       (nlm_rto_1_sgn[SQRT_RECIP_COPW-RAW_CIW+:RTO_CIW+RAW_CIW-1]);                                                                                     //precision : 4.10 
  else 
  assign df_clip_nlm =  
       (nlm_rto_1_sgn[SQRT_RECIP_COPW-R_LOW_NLM_CIPW+:(R_LOW_NLM_CIW+1)] >= step_1_high_nlm_sel_num_que_nxt[(R_LOW_NLM_CIW+1)*(COM_STEP_1_NLM_RTO_DLY)+:(R_LOW_NLM_CIW+1)]) ? 
                     {step_1_high_nlm_sel_num_que_nxt[(R_LOW_NLM_CIW+1)*(COM_STEP_1_NLM_RTO_DLY)+:(R_LOW_NLM_CIW+1)],{RAW_CIW-R_LOW_NLM_CIPW{1'b0}}} :  //compare precision : 4.2
       (nlm_rto_1_sgn[SQRT_RECIP_COPW-R_LOW_NLM_CIPW+:(R_LOW_NLM_CIW+1)] < step_1_low_nlm_sel_num_que_nxt[R_LOW_NLM_CIW*(COM_STEP_1_NLM_RTO_DLY)+:R_LOW_NLM_CIW]) ? 
                     {step_1_low_nlm_sel_num_que_nxt[R_LOW_NLM_CIW*(COM_STEP_1_NLM_RTO_DLY)+:R_LOW_NLM_CIW],{RAW_CIW-R_LOW_NLM_CIPW{1'b0}}} :           //compare precision : 4.2
       (nlm_rto_1_sgn[SQRT_RECIP_COPW-RAW_CIW+:RTO_CIW+RAW_CIW-1] + nlm_rto_1_sgn[SQRT_RECIP_COPW-RAW_CIW-1]);                                          //precision : 4.10 + rounding
...
assign df_step_1_score_nxt             = (df_step_1_score_temp & {RTO_CIW+RAW_CIW{!nlm_rto_1_sgn[RAW_CIW+SQRT_RECIP_COW]}}) >> step_1_sft_sel_num_que_nxt[2*COM_STEP_1_NLM_RTO_DLY+:2];
...
assign step_2_max_sel_num_nxt = ptnl_w_point_nxt ? r_step2_w_rto_thres        : i_step2_b_rto_thres_rng_cu;                                   //precision : 3.2
assign step_2_min_sel_num_nxt = ptnl_w_point_nxt ? i_step2_w_rto_thres_rng_cu : r_step2_b_rto_thres;                                          //precision : 3.2
...
assign step_2_thres_sel_num_5 = ptnl_w_point_que_nxt[COM_STEP_2_COL_STG_1_DLY+:1] ? i_step2_w_rto_thres_5_cu   : i_step2_b_rto_thres_5_cu;    //precision : 7.2
  ...
  for(index=0;index<STAGE_2_NBR_4;index=index+1) begin : gen_step_2_0_color_1_find_score
    ...
    assign step_2_color_1_max_0_sgn_nxt[index] =   
         $signed({ptnl_w_point,1'b1}) * $signed(step_2_max_sel_num) *  //set 
         $signed({1'b0,nlm_sqrt_que_nxt[(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+
                                        (((SQRT_CIW/2)+IP_SQRT_OEXD))*(index+1)+:(((SQRT_CIW/2)+IP_SQRT_OEXD))]});
                                                                                                                                   //precision : (3.2*7.5) = s.10.7
    assign step_2_color_1_max_1_sgn_nxt[index] = step_2_color_1_max_0_sgn[index] + 
         $signed({1'b0,step_2_color_1_que_nxt[RAW_CIW*(STAGE_2_NBR_4*STAGE_2_NBR_4*(COM_STEP_2_CLR_MAX_MIN_CLR_DLY)+(STAGE_2_NBR_4*(index+1)-1))+:RAW_CIW],
                                                                                                                                        {SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW{1'b0}}});
                                        
                                                                                                                                   //precision : 10.0 +- 10.7 = s.10.7 => s.11.7
    assign step_2_color_1_min_0_sgn_nxt[index] =    
         $signed({ptnl_w_point,1'b1}) * $signed(step_2_min_sel_num) * 
         $signed({1'b0,nlm_sqrt_que_nxt[(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+
                                        (((SQRT_CIW/2)+IP_SQRT_OEXD))*(index+1)+:(((SQRT_CIW/2)+IP_SQRT_OEXD))]});
                                                                                                                                   //precision : (3.2*7.5) = s.10.7
    assign step_2_color_1_min_1_sgn_nxt[index] = step_2_color_1_min_0_sgn[index] + 
         $signed({1'b0,step_2_color_1_que_nxt[RAW_CIW*(STAGE_2_NBR_4*STAGE_2_NBR_4*(COM_STEP_2_CLR_MAX_MIN_CLR_DLY)+(STAGE_2_NBR_4*(index+1)-1))+:RAW_CIW],
                                                                                                                                        {SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW{1'b0}}});
                                                                                                                                   //precision : 10.0 +- 10.7 = s.10.7 => s.11.7
      ...
      for(index_2=0;index_2<STAGE_2_NBR_4-1;index_2=index_2+1) begin : gen_step_2_1_color_1_find_score
        if(index_2 != STAGE_2_NBR_4-1) begin
            assign step_2_color_1_clip_sgn_nxt[index*(STAGE_2_NBR_4-1)+index_2] = 
               ($signed({1'b0,step_2_color_1_que_nxt[RAW_CIW*COM_STEP_2_COL_CLIP_DLY*STAGE_2_NBR_4*STAGE_2_NBR_4+RAW_CIW*(index*STAGE_2_NBR_4+index_2)+:RAW_CIW]}) > 
                               $signed(step_2_color_1_max_1_sgn[index][SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW+:RAW_CIW+1])) ? $signed(step_2_color_1_max_1_sgn[index]) :
               ($signed({1'b0,step_2_color_1_que_nxt[RAW_CIW*COM_STEP_2_COL_CLIP_DLY*STAGE_2_NBR_4*STAGE_2_NBR_4+RAW_CIW*(index*STAGE_2_NBR_4+index_2)+:RAW_CIW]}) <= 
                               $signed(step_2_color_1_min_1_sgn[index][SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW+:RAW_CIW+1])) ? $signed(step_2_color_1_min_1_sgn[index]) : 
...
//|:------------------ |:------------------ |:------------------ |:------------------ |:------------------ |:------------------ |:------------------ |
  ...
  for(index=0;index<2;index=index+1) begin : gen_step_2_0_color_2_find_score
    ...
    assign step_2_color_2_max_0_sgn_nxt[index] = 
               $signed({ptnl_w_point,1'b1}) * $signed(step_2_max_sel_num) * 
               $signed({1'b0,nlm_sqrt_que_nxt[(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+
                                        (((SQRT_CIW/2)+IP_SQRT_OEXD))*(STAGE_2_NBR_4+index+1)+:(((SQRT_CIW/2)+IP_SQRT_OEXD))]});  //precision : (3.2*7.5) = s.10.7
                                        
    assign step_2_color_2_max_1_sgn_nxt[index] = step_2_color_2_max_0_sgn[index] + 
               $signed({1'b0,step_2_color_2_que_nxt[RAW_CIW*(STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2*(COM_STEP_2_CLR_MAX_MIN_CLR_DLY)+(STAGE_2_NBR_2_SUB_6*(index+1)-1))+:RAW_CIW],
                                                                                                                                         {SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW{1'b0}}});
                                                                                                                                  //precision : 10.0 +- 10.7 = s.10.7 => s.11.7
    assign step_2_color_2_min_0_sgn_nxt[index] = 
               $signed({ptnl_w_point,1'b1}) * $signed(step_2_min_sel_num) * 
               $signed({1'b0,nlm_sqrt_que_nxt[(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+
                                        (((SQRT_CIW/2)+IP_SQRT_OEXD))*(STAGE_2_NBR_4+index+1)+:(((SQRT_CIW/2)+IP_SQRT_OEXD))]});  //precision : (3.2*7.5) = s.10.7
                                        
    assign step_2_color_2_min_1_sgn_nxt[index] = step_2_color_2_min_0_sgn[index] + 
               $signed({1'b0,step_2_color_2_que_nxt[RAW_CIW*(STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2*(COM_STEP_2_CLR_MAX_MIN_CLR_DLY)+(STAGE_2_NBR_2_SUB_6*(index+1)-1))+:RAW_CIW],
                                                                                                                                         {SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW{1'b0}}});
                                                                                                                                  //precision : 10.0 +- 10.7 = s.10.7 => s.11.7
        ...
        if(index_2 != (6-1)) begin
              assign step_2_color_2_clip_sgn_nxt[index*(6-1)+index_2] = 
                    ($signed({1'b0,step_2_color_2_que_nxt[RAW_CIW*COM_STEP_2_COL_CLIP_DLY*STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2+RAW_CIW*(index*STAGE_2_NBR_2_SUB_6+index_2)+:RAW_CIW]}) > 
                                              $signed(step_2_color_2_max_1_sgn[index][SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW+:RAW_CIW+1])) ? $signed(step_2_color_2_max_1_sgn[index]) :
                    ($signed({1'b0,step_2_color_2_que_nxt[RAW_CIW*COM_STEP_2_COL_CLIP_DLY*STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2+RAW_CIW*(index*STAGE_2_NBR_2_SUB_6+index_2)+:RAW_CIW]}) <= 
                                              $signed(step_2_color_2_min_1_sgn[index][SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW+:RAW_CIW+1])) ? $signed(step_2_color_2_min_1_sgn[index]) : 
...
//|:------------------ |:------------------ |:------------------ |:------------------ |:------------------ |:------------------ |:------------------ |
  ...
  for(index=0;index<2;index=index+1) begin : gen_step_2_0_color_3_find_score
    ...
    assign step_2_color_3_max_0_sgn_nxt[index] = 
                   $signed({ptnl_w_point,1'b1}) * $signed(step_2_max_sel_num) * 
                   $signed({1'b0,nlm_sqrt_que_nxt[(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+
                                                  (((SQRT_CIW/2)+IP_SQRT_OEXD))*(STAGE_2_NBR_4+STAGE_2_NBR_2+index+1)+:(((SQRT_CIW/2)+IP_SQRT_OEXD))]});
                                                                                                                                    //precision : (3.2*7.5) = s.10.7
    assign step_2_color_3_max_1_sgn_nxt[index] = step_2_color_3_max_0_sgn[index] + 
                   $signed({1'b0,step_2_color_3_que_nxt[RAW_CIW*(STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2*(COM_STEP_2_CLR_MAX_MIN_CLR_DLY)+(STAGE_2_NBR_2_SUB_6*(index+1)-1))+:RAW_CIW],
                                                                                                                                         {SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW{1'b0}}});
                                                                                                                                    //precision : 10.0 +- 10.7 = s.10.7 => s.11.7
    assign step_2_color_3_min_0_sgn_nxt[index] =   
                   $signed({ptnl_w_point,1'b1}) * $signed(step_2_min_sel_num) * 
                   $signed({1'b0,nlm_sqrt_que_nxt[(((SQRT_CIW/2)+IP_SQRT_OEXD)*COLOR_ARRAY_NUM_2)*COM_STEP_2_CLR_MAX_MIN_SQRT_DLY+
                                                  (((SQRT_CIW/2)+IP_SQRT_OEXD))*(STAGE_2_NBR_4+STAGE_2_NBR_2+index+1)+:(((SQRT_CIW/2)+IP_SQRT_OEXD))]});
                                                                                                                                    //precision : (3.2*7.5) = s.10.7
    assign step_2_color_3_min_1_sgn_nxt[index] = step_2_color_3_min_0_sgn[index] + 
                   $signed({1'b0,step_2_color_3_que_nxt[RAW_CIW*(STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2*(COM_STEP_2_CLR_MAX_MIN_CLR_DLY)+(STAGE_2_NBR_2_SUB_6*(index+1)-1))+:RAW_CIW],
                                                                                                                                         {SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW{1'b0}}});
                                                                                                                                    //precision : 10.0 +- 10.7 = s.10.7 => s.11.7
      for(index_2=0;index_2<(6-1);index_2=index_2+1) begin : gen_step_2_1_color_3_find_score
        if(index_2 != (6-1)) begin
              ...
              ($signed({1'b0,step_2_color_3_que_nxt[RAW_CIW*COM_STEP_2_COL_CLIP_DLY*STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2+RAW_CIW*(index*STAGE_2_NBR_2_SUB_6+index_2)+:RAW_CIW]}) > 
                                              $signed(step_2_color_3_max_1_sgn[index][SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW+:RAW_CIW+1])) ? $signed(step_2_color_3_max_1_sgn[index]) :
              ($signed({1'b0,step_2_color_3_que_nxt[RAW_CIW*COM_STEP_2_COL_CLIP_DLY*STAGE_2_NBR_2_SUB_6*STAGE_2_NBR_2+RAW_CIW*(index*STAGE_2_NBR_2_SUB_6+index_2)+:RAW_CIW]}) <= 
                                              $signed(step_2_color_3_min_1_sgn[index][SQRT_COPW+R_RTO_THRES_CIPW-RAW_CIPW+:RAW_CIW+1])) ? $signed(step_2_color_3_min_1_sgn[index]) : 
...
assign step_2_color_total_sum_0_nxt = step_2_color_1_score_stage_3[0] + //2.10 
                                      step_2_color_1_score_stage_3[1];  //2.10
 

assign step_2_color_total_sum_1_nxt = step_2_color_1_score_stage_3[2] + //2.10
                                      step_2_color_1_score_stage_3[3] ; //2.10

assign step_2_color_total_sum_2_nxt = step_2_color_2_score_stage_3[0] + //3.10
                                      step_2_color_2_score_stage_3[1] ; //3.10
                                     
assign step_2_color_total_sum_3_nxt = step_2_color_3_score_stage_3[0] + //3.10  
                                      step_2_color_3_score_stage_3[1] ; //3.10  
                                      
                                      
assign step_2_color_total_sum_4_nxt = step_2_color_total_sum_0 + step_2_color_total_sum_1; //4.10                                     
assign step_2_color_total_sum_5_nxt = step_2_color_total_sum_2 + step_2_color_total_sum_3; //5.10
assign step_2_color_total_sum_nxt   = step_2_color_total_sum_4 + step_2_color_total_sum_5 + {1'b1,1'b0}; //6.10   //range from 0~32 => 0~8  //rounding 
...
assign repl_pixel_0_nxt               = target_pixel_que_nxt[(RAW_CIW)*COM_STEP_2_REPL_DLY+:(RAW_CIW)]* df_all_step_score_inv_nxt ;   //RAW_CIW * 1.10 + RAW_CIW * 1.10 +rounding
assign repl_pixel_1_nxt               = raw_fnl_sel_num_que_nxt[(RAW_CIW)*(COM_STEP_2_REPL_RAW_FNL_DLY)+:(RAW_CIW)]* 
                                        df_all_step_score[RAW_CIW+:RAW_CIW+1] + {1'b1,{RAW_CIW-1{1'b0}}};                             //RAW_CIW * 1.10 + RAW_CIW * 1.10 +rounding
assign repl_pixel_total_nxt           =  repl_pixel_0 + repl_pixel_1;
...
generate 
  if(MODE_SEL == 1'd1) begin   
    assign step_2_en_nxt                = 0;
  end 
  else  begin                                   
    assign step_2_en_nxt                = !df_all_step_score_inv[RAW_CIW];
  end 
endgenerate
...
generate   //static_confidence_start 
  ...
  assign target_repl          = step_2_en ? repl_pixel_total[RAW_CIW+:RAW_CIW+1] : target_pixel_que_nxt[(RAW_CIW)*COM_STEP_2_TAR_REPL_DLY+:(RAW_CIW)];
  end 
...
//--------------------------------------------------------------------------------------step 2 get neighbor score 
  step_2_min_sel_num          <= 0;
  step_2_max_sel_num          <= 0;
  ...
  step_2_color_total_sum_3    <= 0;
  step_2_color_total_sum_4    <= 0;
  step_2_color_total_sum_5    <= 0;
...
//--------------------------------------------------------------------------------------step 1 pixel result
  ...
  step_1_high_nlm_sel_num     <= step_1_high_nlm_sel_num_nxt;
  nlm_rto_0_sgn               <= nlm_rto_0_sgn_nxt;
  nlm_rto_1_sgn               <= nlm_rto_1_sgn_nxt;
...
//--------------------------------------------------------------------------------------step 2 get neighbor score 
  step_2_min_sel_num          <= step_2_min_sel_num_nxt;
  step_2_max_sel_num          <= step_2_max_sel_num_nxt;
  ...
  step_2_color_total_sum_3    <= step_2_color_total_sum_3_nxt;
  step_2_color_total_sum_4    <= step_2_color_total_sum_4_nxt;
  step_2_color_total_sum_5    <= step_2_color_total_sum_5_nxt;
...
//--------------------------------------------------------------------------------------step 2 get confidence score 
  ...
  repl_pixel_0                <= repl_pixel_0_nxt;
  repl_pixel_1                <= repl_pixel_1_nxt;
  repl_pixel_total            <= repl_pixel_total_nxt;
  step_2_en                   <= step_2_en_nxt;
...
//--------------------------------------------------------------------------------------step 2 get neighbor score 
  ...
  step_2_color_1_max_0_sgn[int_index]         <= 0; 
  step_2_color_1_min_0_sgn[int_index]         <= 0; 
  step_2_color_1_max_1_sgn[int_index]         <= 0; 
  step_2_color_1_min_1_sgn[int_index]         <= 0; 
...
//--------------------------------------------------------------------------------------step 2 get neighbor score 
  ...
  step_2_color_1_max_0_sgn[int_index]         <= step_2_color_1_max_0_sgn_nxt[int_index]; 
  step_2_color_1_min_0_sgn[int_index]         <= step_2_color_1_min_0_sgn_nxt[int_index]; 
  step_2_color_1_max_1_sgn[int_index]         <= step_2_color_1_max_1_sgn_nxt[int_index]; 
  step_2_color_1_min_1_sgn[int_index]         <= step_2_color_1_min_1_sgn_nxt[int_index]; 
  end
end 
end
...
//--------------------------------------------------------------------------------------step 2 get neighbor score 
  ...
  step_2_color_2_max_0_sgn[int_index]         <= 0; 
  step_2_color_3_max_0_sgn[int_index]         <= 0; 
  step_2_color_2_min_0_sgn[int_index]         <= 0; 
  step_2_color_3_min_0_sgn[int_index]         <= 0;
  step_2_color_2_max_1_sgn[int_index]         <= 0; 
  step_2_color_3_max_1_sgn[int_index]         <= 0; 
  step_2_color_2_min_1_sgn[int_index]         <= 0; 
  step_2_color_3_min_1_sgn[int_index]         <= 0;
...
//--------------------------------------------------------------------------------------step 2 get neighbor score 
  ...
  step_2_color_2_max_0_sgn[int_index]         <= step_2_color_2_max_0_sgn_nxt[int_index]; 
  step_2_color_3_max_0_sgn[int_index]         <= step_2_color_3_max_0_sgn_nxt[int_index]; 
  step_2_color_2_min_0_sgn[int_index]         <= step_2_color_2_min_0_sgn_nxt[int_index]; 
  step_2_color_3_min_0_sgn[int_index]         <= step_2_color_3_min_0_sgn_nxt[int_index]; 
  step_2_color_2_max_1_sgn[int_index]         <= step_2_color_2_max_1_sgn_nxt[int_index]; 
  step_2_color_3_max_1_sgn[int_index]         <= step_2_color_3_max_1_sgn_nxt[int_index]; 
  step_2_color_2_min_1_sgn[int_index]         <= step_2_color_2_min_1_sgn_nxt[int_index]; 
  step_2_color_3_min_1_sgn[int_index]         <= step_2_color_3_min_1_sgn_nxt[int_index]; 
  end
end 
end
...
always@(posedge dpc_clk or negedge dpc_rst_n) begin 
if(!dpc_rst_n) begin
  for(int_index=0;int_index<RAW_CIW-1;int_index=int_index+1) begin : rst_12_gen
    result_max_sel[int_index]                 <= 0;
    result_min_sel[int_index]                 <= 0;
  end 
end 
else begin 
  for(int_index=0;int_index<RAW_CIW-1;int_index=int_index+1) begin : rst_13_gen
    result_max_sel[int_index]                 <= result_max_sel_nxt[int_index];
    result_min_sel[int_index]                 <= result_min_sel_nxt[int_index];
  end 
end 
end 
...
if(!dpc_rst_n) begin
  ...
  for(int_index=0;int_index<RAW_CIW;int_index=int_index+1) begin : rst_5_gen
    data_bit_pipe[int_index]                  <= data_bit_pipe_nxt[int_index];
...
for(int_index=0;int_index<COLOR_ARRAY_NUM_2;int_index=int_index+1) begin : rst_10_gen
  ...
  total_nlm_0   [int_index] <= total_nlm_0_nxt[int_index];
...
ip_sqrt_pw#(
    ...
    .o_sqrt       ( nlm_sqrt_nxt[((SQRT_CIW/2)+IP_SQRT_OEXD)*index+:((SQRT_CIW/2)+IP_SQRT_OEXD)]       ),        //precision : 7.5
