...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_seven_seg is
  ...
  attribute SOFT_HLUTNM of \deb_cnt[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \deb_cnt[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \o_seg_1[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_seg_1[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_seg_1[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_seg_1[3]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \o_seg_1[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_seg_2[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_seg_2[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_seg_2[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_seg_2[3]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \seq_1st_cnt[2]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \seq_2nd_cnt[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \seq_2nd_cnt[2]_i_1\ : label is "soft_lutpair0";
begin
...
\seq_1st_cnt[2]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2000000000000000"
    )
        port map (
