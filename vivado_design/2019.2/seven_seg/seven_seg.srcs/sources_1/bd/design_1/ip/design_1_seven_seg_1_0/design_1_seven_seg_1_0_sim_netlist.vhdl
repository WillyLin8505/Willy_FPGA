...
--               C:/Users/sssss/OneDrive/vivado_part/2019.2/seven_seg/seven_seg.srcs/sources_1/bd/design_1/ip/design_1_seven_seg_1_0/design_1_seven_seg_1_0_sim_netlist.vhdl
...
entity design_1_seven_seg_1_0_seven_seg is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_seven_seg_1_0_seven_seg : entity is "seven_seg";
end design_1_seven_seg_1_0_seven_seg;

architecture STRUCTURE of design_1_seven_seg_1_0_seven_seg is
  ...
  signal \seq_1st_9_cnt_eq__2\ : STD_LOGIC;
  signal \seq_1st_cnt[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \seq_1st_cnt[3]_i_8_n_0\ : STD_LOGIC;
  signal \seq_1st_cnt[3]_i_9_n_0\ : STD_LOGIC;
  signal \seq_1st_cnt_clr1__0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \always_cnt[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \always_cnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \deb_cnt[0]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \deb_cnt[0]_i_6\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \deb_keep[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_seg[0]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_seg[1]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \o_seg[2]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \o_seg[2]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_seg[3]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \o_seg[3]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \o_seg[4]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_seg[5]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \o_seg[6]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \seq_1st_cnt[1]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \seq_1st_cnt[2]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \seq_1st_cnt[2]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_10\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_11\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_13\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_14\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_8\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_9\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \seq_2nd_cnt[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \seq_2nd_cnt[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \seq_2nd_cnt[3]_i_4\ : label is "soft_lutpair9";
begin
...
\seq_1st_cnt[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00BB0BBB"
    )
        port map (
...
\seq_1st_cnt[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000003700370000"
    )
        port map (
      I0 => i_button_clr,
      I1 => deb_trg,
      I2 => \seq_1st_cnt[3]_i_6_n_0\,
      I3 => cnt_2nd_add_minus_sgn(1),
      I4 => \seq_1st_cnt_reg_n_0_[0]\,
      I5 => \seq_1st_cnt[1]_i_2_n_0\,
      O => seq_1st_cnt_nxt(1)
    );
\seq_1st_cnt[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\seq_1st_cnt[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E8"
    )
        port map (
...
\seq_1st_cnt[3]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\seq_1st_cnt[3]_i_12\: unisim.vcomponents.LUT6
    generic map(
...
\seq_1st_cnt[3]_i_14\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAA8"
    )
        port map (
...
\seq_1st_cnt[3]_i_15\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\seq_1st_cnt[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00EE0EEE"
    )
        port map (
...
\seq_1st_cnt[3]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\seq_1st_cnt[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\seq_1st_cnt[3]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7EF0810"
    )
        port map (
...
\seq_1st_cnt[3]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\seq_2nd_cnt[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
...
\seq_2nd_cnt[3]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
entity design_1_seven_seg_1_0 is
  ...
  attribute NotValidForBitStream of design_1_seven_seg_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_seven_seg_1_0 : entity is "design_1_seven_seg_1_0,seven_seg,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_seven_seg_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_seven_seg_1_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_seven_seg_1_0 : entity is "seven_seg,Vivado 2019.2";
end design_1_seven_seg_1_0;

architecture STRUCTURE of design_1_seven_seg_1_0 is
...
begin
U0: entity work.design_1_seven_seg_1_0_seven_seg
     port map (
      clk => clk,
