...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_seven_seg is
  ...
  signal deb_cnt_clr_ext0 : STD_LOGIC;
  signal deb_cnt_reg : STD_LOGIC_VECTOR ( 16 downto 0 );
  signal \deb_cnt_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \deb_cnt_reg[0]_i_1_n_1\ : STD_LOGIC;
  signal \deb_cnt_reg[0]_i_1_n_2\ : STD_LOGIC;
  signal \deb_cnt_reg[0]_i_1_n_3\ : STD_LOGIC;
  signal \deb_cnt_reg[0]_i_1_n_4\ : STD_LOGIC;
  signal \deb_cnt_reg[0]_i_1_n_5\ : STD_LOGIC;
  signal \deb_cnt_reg[0]_i_1_n_6\ : STD_LOGIC;
  signal \deb_cnt_reg[0]_i_1_n_7\ : STD_LOGIC;
  ...
  signal deb_keep : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \always_cnt[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \always_cnt[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \deb_keep[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_seg[0]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_seg[1]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \o_seg[2]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \o_seg[3]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_seg[3]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_seg[3]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_seg[4]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_seg[5]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \o_seg[6]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \seq_1st_cnt[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \seq_1st_cnt[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_10\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \seq_1st_cnt[3]_i_9\ : label is "soft_lutpair9";
...
\deb_cnt[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\deb_cnt[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"90"
    )
        port map (
      I0 => \deb_keep_reg_n_0_[1]\,
      I1 => deb_keep(0),
      I2 => deb_cnt_reg(3),
      O => \deb_cnt[0]_i_3_n_0\
    );
\deb_cnt[0]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"90"
    )
        port map (
...
\deb_cnt[0]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"90"
    )
        port map (
...
\deb_cnt[0]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"41"
    )
        port map (
...
\deb_cnt_reg[0]\: unisim.vcomponents.FDCE
     port map (
      ...
      CE => '1',
      CLR => \o_seg[6]_i_2_n_0\,
      D => \deb_cnt_reg[0]_i_1_n_7\,
      Q => deb_cnt_reg(0)
    );
\deb_cnt_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \deb_cnt_reg[0]_i_1_n_0\,
      CO(2) => \deb_cnt_reg[0]_i_1_n_1\,
      CO(1) => \deb_cnt_reg[0]_i_1_n_2\,
      CO(0) => \deb_cnt_reg[0]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => deb_cnt_clr_ext0,
      O(3) => \deb_cnt_reg[0]_i_1_n_4\,
      O(2) => \deb_cnt_reg[0]_i_1_n_5\,
      O(1) => \deb_cnt_reg[0]_i_1_n_6\,
      O(0) => \deb_cnt_reg[0]_i_1_n_7\,
      S(3) => \deb_cnt[0]_i_3_n_0\,
      S(2) => \deb_cnt[0]_i_4_n_0\,
      S(1) => \deb_cnt[0]_i_5_n_0\,
      S(0) => \deb_cnt[0]_i_6_n_0\
    );
